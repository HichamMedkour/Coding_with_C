...
//#include <stdlib.h>
//
//enum type {sun,mon,tues,wedn,thurs,frid,sat}; // define new type
//
//typedef enum type xxx;
//void print_day(xxx d)
//{
//        switch (d){
//                case sun:printf("sunday");break;
//                case mon:printf("monday");break;
//                case tues:printf("tuesday");break;
//                case wedn:printf("wednesday");break;
//                case thurs:printf("thursday");break;
//                case frid:printf("friday");break;
